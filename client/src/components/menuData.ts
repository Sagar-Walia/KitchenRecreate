...
const menuData: MenuItem[] = [
  ...
  },
  {
    id: 17,
    name: "Kaju Masala",
    description: "Rich and creamy North Indian curry that features roasted cashews in a spicy, flavorful gravy. The dish is a popular choice in Indian restaurants and is often considered a special meal due to its decadent taste and texture.",
    price: 300,
    weight: "box",
